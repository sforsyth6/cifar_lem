...
def main():
    ...
    if args.pretrained:
        ...
        if not args.cifar:
            ...
            model = models.resnet_cifar.__dict__[args.arch](low_dim=args.low_dim)
...
#    transform = transforms.Compose([transforms.ToTensor(), normalize])
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 10 == 0:
            ...
            prec1 = kNN(0, model, lemniscate, train_loader, val_loader, 200, args.nce_t)
...
def train(train_loader, model, lemniscate, criterion, optimizer, epoch):
    ...
    for i, (input, _, index) in enumerate(train_loader):
        ...
        reg = lemniscate.regularizer()
        loss = criterion(output, index, reg) / args.iter_size
...
def adjust_learning_rate(optimizer, epoch):
    ...
    if epoch < 20:
        lr = args.lr
    elif epoch >= 20 and epoch < 120 and epoch % 20 == 0:
        lir = args.lr*0.8
    elif epoch >= 120 and epoch < 160 and epoch % 20 == 0:
        lr = args.lr * 0.1
    elif epoch >= 160 and epoch % 10 == 0:
        lr = args.lr * 0.01
